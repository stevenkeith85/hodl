...
// DAOs - 0xed9ec5c832d6b9bdf77e2b0a1afca53592d72ddf

// Ryuzu - 0x18FEFc61F4974481013bB5a4397a6fc52e108298 (linked to 97 accounts with a distance of 6 (170 per page), money flowing out)
// ["0xb8a265f01e2DB57cE3f599868538e909a13C7fBB","abigaild","adamus","agathe","agathi","aileen","alfaiz","aliana","alwanfakhru","amandalyn","amorim_ross","andyrt","anilarry","anny","arnold_rt","astridewi","catsofworld","charlie_dh","cily","clara","cloudyist","corinne","cristy","delioveira","dino","dobsky","doggg","dragon","eunice_adelia","faisa","fikaty","gaiazando","george","giselly","gluck","jaduu","jenkim","jennstel","jenny","juan_alers","justinemarie","kelubia","krzysiek","kucing","kumshaj","lawe","lenney","lucy","lylia_naz","lyna_rya","majlodog","mama_milka","mamanela","marcoba","markyklau","maryleexo","meiry","metatera","mezafamily","misslidabutik","moulin","myadog","myboys","nabila","nagami","nammy","nana","powermom","priskaanastasia","rahmatanah","raniseptya","raxezy","ricky","rojas","ryuzu","sarah","shanne","snowman","sobrevilla","soyeoni","spencerpenny","sunset","szksae","teja","tuccina","tuiaekpon","tynatun","vahadie","veroniky","watchanon","white_cherry","willyyy","wyra","xyniy","yuto","zuzanka","zyyi"]

// Wadwed - 0xc74f9118565b1e6Cb3D67A9Bf593Ca5133e7E8C6 (linked to 15 accounts with a distance of 4, (170 per page),money flowing out)
...
// Verani - 0x47878d4e984FDaf3069D14F8B6F27d9454e917ef (linked to 24 accounts with a distance of 4, (170 per page), money flowing out)
...
// Samudra - 0xa19775bB9aE7910BcfCc25E9257F6d8A28D9Bb3D (linked to 35 accounts with a distance of 4, (170 per page), money flowing out)
...
// Lilis - 0x4F56118ac3D73618900D3C89B38e4582F5aC659F (linked to 7 accounts with a distance of 6, (100 per page), money flowing out)
// ["glicoxxx","lilis","lulu","nissa","rantymm","regina","risty"]

let user = ["0xED9eC5c832d6b9BdF77e2B0A1Afca53592d72ddF"]
let associatedAddresses = await findAssociateAddresses(user, 'in', 3, 50);

        ...
        <Box marginY={4}>
            <Stack spacing={6}>
                ...
                <Box
                    ...
                    <Typography mb={4} variant="h2" color="primary" sx={{ fontSize: '18px'}}>Quick Start</Typography>
                ...
                <Box>
                    <Typography mb={1} variant="h2" color="primary">Do Your Own Research</Typography>
